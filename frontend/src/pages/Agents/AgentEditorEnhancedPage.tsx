                ...
                <div className="flex items-center space-x-3">
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const generatedPrompt = `你是一个专业的${agentConfig.promptTuning.role || '智能助手'}，${agentConfig.description}。

角色定义：
- 主要职责：${agentConfig.promptTuning.role || '智能助手'}
- 行为准则：${agentConfig.promptTuning.behavior || '友好、专业、准确'}
- 响应风格：清晰、有用、及时
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button
                    ...
                    startIcon={<Sparkles />}
                    onClick={() => {
                      // Auto-tune prompt based on current system prompt and dataset
                      const currentPrompt = agentConfig.systemPrompt
                      const tunedPrompt = currentPrompt
                        .replace(/示例对话：\n(.+?)\n\n请根据以上配置，为用户提供最好的服务体验。/, 
                          `示例对话：
${agentConfig.promptTuning.examples || '用户：你好\n助手：您好！我是您的智能助手，有什么可以帮助您的吗？'}
...
请根据以上配置，为用户提供最好的服务体验。`)
                      ...
                      setAgentConfig(prev => ({
                        ...prev,
                        systemPrompt: tunedPrompt
                      }))
                      setSnackbar({ open: true, message: '提示词自动调优成功！', severity: 'success' })
                    }}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <FormControl fullWidth>
                      ...
                      <TextField
                        fullWidth
                        type="number"
                        value={agentConfig.promptTuning.learningRate || 0.001}
                        onChange={(e) => setAgentConfig(prev => ({
                          ...prev,
                          promptTuning: { 
                            ...prev.promptTuning, 
