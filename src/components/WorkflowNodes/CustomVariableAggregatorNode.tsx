    ...
    `}>
      ...
      <div className="px-3 py-2 space-y-2">
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-500">聚合方式</span>
          <span className="text-xs text-gray-600">{data.method || '合并'}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-500">输入变量</span>
          <span className="text-xs text-gray-600">{data.inputVars || 2}个</span>
        </div>
        <div className="flex items-center justify-between">
